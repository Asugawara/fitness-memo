...
>
> **必要な量が桁で違う。** minify 後の LCP は約 3,195ms で、カテゴリ 95 の境界は 3,032ms。
> 163ms 詰めるには転送を **−33,382B** 動かす必要があり、wasm 全体の圧縮率 2.51:1 で
> 固有コードに換算すると約 **−84KB raw** — release wasm の code セクション
> 996,642B（全体の 89.4%。data は 101,003B / 関数 4,762 本）の 8.4% にあたる。
